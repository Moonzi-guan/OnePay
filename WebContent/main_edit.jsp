...
$(function(){
	//获得当前回显的user的权限
	$("#power option[value='${user.power }']").prop("selected",true);
	//是否锁定
	$("#lock option[value='${user.lock }']").prop("selected",true);
});
...
<body>
	...
	<table width="99%" border="0" cellspacing="0" cellpadding="0"
		...
		<tr>
			<td align="left" valign="top" id="addinfo"><a href="#"
				target="mainFrame"  class="add">新增管理员</a></td>
		</tr>
		<tr>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0"
						...
						<tr onMouseOut="this.style.backgroundColor='#ffffff'"
							...
							<td align="right" valign="middle"
								class="borderright borderbottom bggray">用户名：</td>
							<td align="left" valign="middle"
								class="borderright borderbottom main-for"><input
								type="text" name="username" value="${user.username }" class="text-word"></td>
						</tr>
						<tr onMouseOut="this.style.backgroundColor='#ffffff'"
							onMouseOver="this.style.backgroundColor='#edf5ff'">
							<td align="right" valign="middle"
							...
							<td align="left" valign="middle"
								class="borderright borderbottom main-for"><input
								type="text" name="password" value="${user.password }" class="text-word"></td>
						</tr>
						<tr onMouseOut="this.style.backgroundColor='#ffffff'"
							onMouseOver="this.style.backgroundColor='#edf5ff'">
							<td align="right" valign="middle"
								class="borderright borderbottom bggray">锁定：</td>
							<td align="left" valign="middle"
						...
						<tr onMouseOut="this.style.backgroundColor='#ffffff'"
							onMouseOver="this.style.backgroundColor='#edf5ff'">
							<td align="right" valign="middle"
								class="borderright borderbottom bggray">用户权限：</td>
							<td align="left" valign="middle"
								class="borderright borderbottom main-for">
								<select name="power" id="power">
								<c:forEach items="${powerList }" var="power">
									<option value="${power.powername}">&nbsp;&nbsp;${power.powername} </option>
								</c:forEach>
							</select></td>
						</tr>
						<tr onMouseOut="this.style.backgroundColor='#ffffff'"
